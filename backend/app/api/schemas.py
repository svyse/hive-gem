...
class RunCreateRequest(BaseModel):
    ...
    backend: Optional[str] = Field(None, description="Ignored in startup-only mode; use backend/.env LLM_BACKEND and restart FastAPI")
...
class ModelBackendSetRequest(BaseModel):
    backend: str = Field(..., description="Startup LLM backend request; runtime switching is disabled")
